namespace Schema.Internal.Types
{
    ...
    [ExcludeTypes(typeof(UnityEngine.Matrix4x4))]
    ...
    [Color("#2b7489")]
    [UseExternalTypeDefinition(typeof(UnityEngine.Vector2))]
    public class Vector2 : EntryType { }

    [Color("#563d7c")]
    [UseExternalTypeDefinition(typeof(UnityEngine.Vector3))]
    ...
    [Color("#292929")]
    [UseExternalTypeDefinition(typeof(UnityEngine.Quaternion))]
    public class Quaternion : EntryType { }

    [Color("#b07219")]
    [UseExternalTypeDefinition(typeof(System.Collections.Generic.List<UnityEngine.GameObject>))]
    public class GameObjectList : EntryType { }

    [Color("#dea584")]
    [UseExternalTypeDefinition(typeof(System.Collections.Generic.List<UnityEngine.Transform>))]
    public class TransformList : EntryType { }

    [Color("#3572A5")]
    [UseExternalTypeDefinition(typeof(UnityEngine.AnimationCurve))]
    public class AnimationCurve : EntryType { }

    [Color("#00ADD8")]
    [UseExternalTypeDefinition(typeof(UnityEngine.Rect))]
    public class Rect : EntryType { }

    [Name("bool")]
    [Color("#427819")]
    [UseExternalTypeDefinition(typeof(bool))]
    public class Bool : EntryType { }

    [Color("#438eff")]
    [UseExternalTypeDefinition(typeof(UnityEngine.Vector2Int))]
    public class Vector2Int : EntryType { }

    [Color("#6866fb")]
    [UseExternalTypeDefinition(typeof(UnityEngine.Vector3Int))]
