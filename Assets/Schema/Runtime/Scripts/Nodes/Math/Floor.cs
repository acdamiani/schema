...
namespace Schema.Builtin.Nodes
{
    ...
    public class Floor : Action
    {
        ...
        [Tooltip("Selector to store the floored value in"), WriteOnly] public BlackboardEntrySelector<float> result;
        [Tooltip("Convert the floored value to an integer")] public bool floorToInt = true;
