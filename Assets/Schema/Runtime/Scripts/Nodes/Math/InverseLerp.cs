...
namespace Schema.Builtin.Nodes
{
    ...
    {
        [Tooltip("Float to use to determine position")] public BlackboardEntrySelector<float> value;
        ...
        [Tooltip("Position of the float in the range (between 0 and 1)"), WriteOnly] public BlackboardEntrySelector<float> result;
