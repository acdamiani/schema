...
namespace Schema.Builtin.Nodes
{
    ...
    [Description("Invoke a method specified by a name, at a specified time from now, and repeat after a specified amount of time indefinitely")]
    public class InvokeRepeating : Action
    {
        ...
        [Tooltip("The rate at which the method is repeated")] public BlackboardEntrySelector<float> repeatRate;
