...
namespace Schema.Builtin.Nodes
{
    ...
    public class CancelInvoke : Action
    {
        ...
        [Tooltip("Whether to cancel all methods")] public bool cancelAll;
        [Tooltip("Name of method to cancel invoke for")] public BlackboardEntrySelector<string> methodName;
