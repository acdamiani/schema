...
namespace Schema.Builtin.Nodes
{
    ...
    [Category("GameObject")]
    [Description("Calls a named method on every MonoBehaviour in a specified GameObject and on every ancestor of the behaviour.")]
    public class SendMessageUpwards : Action
    {
        [Tooltip("GameObject to send the message to")] public BlackboardEntrySelector<GameObject> gameObject;
